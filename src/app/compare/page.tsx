...
export default function PlayerComparison() {
    ...
    const [dataStats, setDataStats] = useState<PlayerStats[]>([]);
    ...
    const [dataStats2, setDataStats2] = useState<PlayerStats[]>([]);
    const [searchText2, setSearchText2] = useState<string>("");
    const [selectedPlayer2, setSelectedPlayer2] = useState<Player | null>(null);
    const [selectedPlayerStats2, setSelectedPlayerStats2] = useState<PlayerStats | null>(null);

    useEffect(() => {
        const fetchData = async () => {
            try {
                const [playersSnapshot, attackStatsSnapshot] = await Promise.all([
                ...
                const attackStats = attackStatsSnapshot.docs.map(doc => ({
                    id: doc.id,
                    ...doc.data()
                })) as PlayerStats[];

                setData(players);
                setDataStats(attackStats);
                setData2(players);
                setDataStats2(attackStats);
            ...
            {selectedPlayer && (
                <div className={styles.playerInfo}>
                    <div className={styles.playerData1}>
                        ...
                        <li>
                            <Flag code={countryNameToCode[selectedPlayer.country]} alt={selectedPlayer.country} className={styles.flag} />
            ...
            {selectedPlayer2 && (
                <div className={styles.playerInfo}>
                    <div className={styles.playerData}>
                        ...
                        <li>
                            <Flag code={countryNameToCode[selectedPlayer2.country]} alt={selectedPlayer2.country} className={styles.flag} />
